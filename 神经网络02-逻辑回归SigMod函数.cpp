...
//			float ys = 1.0f / (1.0f + expf(-y));//sigmod函数(激活函数)
//			float loss = sample.y - ys;//损失值
...
//	//	+ a7 * test.x7 + a8 * test.x8 + a9 * test.x9 + b;//最后一个样本，结果正确
//	/*float y = a1 * 0.5 + a2 * 0.4 + a3 * 0.4 + a4 * 0.5 + a5 * 0.7 + a6 * 1.0 + a7 * 0.3 + a8 * 0.2 + a9 * 0.1 + b;*///第二个样本，结果错误
//	int pass = 0;
//	for (int j = 0; j < 682; j++)
//	{
//		Sample test02;
